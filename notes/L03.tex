...
\lecture{3 --- September 27, 2016}{Fall 2016}{Patrick Lam}{version 1}
...
\includegraphics[width=.4\textwidth]{images/oracle_clr.png}
\begin{minipage}{2em} versus \vspace*{1.4em}
\end{minipage}
\includegraphics[width=.4\textwidth]{images/g-header-2480.png}
